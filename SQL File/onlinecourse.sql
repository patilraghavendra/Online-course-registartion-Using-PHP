...
CREATE TABLE `attendance` (
    ...
    `attendancereport` VARCHAR(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO  `attendance`(`id`,`studentname`,`registrationnumber`,`attendancereport`) 
VALUES(1,'Rathan','PES2UG21CS418','Present'),(2,'Rashid','PES2UG21CS424','Present'),(3,'Raghavendra','PES2UG21CS413','Present');
