...
<?php if($_SESSION['alogin']!="")
{
 ...
 ?>
   ...
   <div class="form-group">
    <label for="department">Announcements Title </label>
    <input type="text" class="form-control" id="Announcementstitle" name="Announcementstitle" placeholder="Announcements Title" required />
  </div>

     <div class="form-group">
    <label for="department">Announcements description </label>
    <textarea class="form-control" id="description" name="description" placeholder="Announcements Description" required></textarea>
  </div>
